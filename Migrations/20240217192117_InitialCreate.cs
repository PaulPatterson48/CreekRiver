        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxReservationDays = table.Column<int>(type: "integer", nullable: true),
                    FeePerNight = table.Column<decimal>(type: "numeric", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CampsiteTypeId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
